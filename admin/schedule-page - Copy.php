...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <tr class="odd gradeX" id="device-view-font">
            ...
            <td>'.$row["weekday"].'</td>
            <td><a class="btn btn-danger" href="schedule-page.php?id='.$row["id"].'">Delete Schedule</a>
            <a class="btn btn-success" href="schedule-edit-page.php?id='.$row["id"].'">Edit Schedule</a></td>';
                    }
                } else {
                    echo "
