...
<h3 id="top-nav-font">All Alerts.</h3>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <tr class="odd gradeX" id="device-view-font">
            ...
            <td>'.$row["relay"].'</td>
            <td>'.$row["positions"].'</td>
            <td><a class="btn" id="custom_danger_btn" href="alert-page.php?del='.$row["id"].'">Delete Alert</a>
            <a class="btn" id="custom_success_btn" href="alert-edit-page.php?id='.$row["id"].'">Edit Alert</a></td>';
                    }
                } else {
                    echo "
...
if(isset($_GET["del"])){
    ...
    if(mysqli_query($con, $query)){
        echo '
            <script>
              alert("Alert Deleted!");
              window.location.replace("alert-page.php");
            </script>
          ';
    }
}
